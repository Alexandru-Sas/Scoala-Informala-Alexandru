...
public abstract class Ford extends Car {
    ...
    public Ford(int tankSize, FuelType fuelType, int gears, double consumption, float availableFuel, int tireSize, String chassisNumber, int currentGear, String model) {
