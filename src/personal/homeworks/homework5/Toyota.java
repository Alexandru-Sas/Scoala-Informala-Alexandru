...
public abstract class Toyota extends Car {
    ...
    public Toyota(int tankSize, FuelType fuelType, int gears, float consumption, float availableFuel, int tireSize, String chassisNumber, int currentGear, String model) {
